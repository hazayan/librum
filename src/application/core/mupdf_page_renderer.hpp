...
/**
 * The Mupdf Renderer is the low level class that is responsible for any kind
 ...
 */
class APPLICATION_EXPORT MupdfPageRenderer
{
public:
    MupdfPageRenderer(std::unique_ptr<mupdf::FzPage> page,
