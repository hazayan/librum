...
/**
 * The OpenedBookService is set up with the currently opened book and operates
 * only on it. It is able to get and change information on one specific book.
 */
class APPLICATION_EXPORT IOpenedBookService : public QObject
{
    Q_OBJECT

public:
    virtual ~IOpenedBookService() noexcept = default;
